...
public class payment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("payment_mode");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "COD", "UPI", "debit card", "credit card" }));

        jLabel3.setText("amount");

        jLabel4.setText("med_name");
...
System.out.println("Collection Accessed");
   BasicDBObject doc = new BasicDBObject("med_name", jTextField1.getText()).append("amount",jTextField2.getText()).append("payment",jComboBox1.getSelectedItem());
